...
file_array=(input01.csv input02.csv input03.csv input04.csv input05.csv input06.csv input07.csv input08.csv input09.csv input10.csv input11.csv input12.csv input13.csv input14.csv)
end_array=(100001 200001 300001 400001 500001 750001 1000001 2000001 5000001 10000001 20000001 50000001 100000001 500000001)

for i in {0..13}; do
    head -n ${end_array[$i]} generated_data_1B.csv > ${file_array[$i]}
